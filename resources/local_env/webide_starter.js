...
loadResourceSync(
    "node_modules/webide-client-tools/resources/local_env/fake_plugins.js",
    "js"
)
loadResourceSync(
    actualOptions.webappPath +
        "test-resources/sap/watt/sane-tests/ui5Version.js",
    "js"
)
...
function startWebIDE(options) {
    ...
    var url =
        actualOptions.base_index_html + "?sap-ide-static-ws&sap-ide-iframe"
