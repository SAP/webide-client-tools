...
module.exports = function(rootConfigFolder, rootConfigFIleName) {
    const actualRootConfigFolder = `${pathUtils.isAbsolute(rootConfigFolder)
        ? rootConfigFolder
    ...
    function readConfigsMeta(path, fileName, includedIn, isRoot) {
        ...
        const extPlugins = _.values(
            configWithDefaults.deprecatedPluginExtensions
        )
    ...
    function readInterfacesMeta() {
        ...
        interfacesMeta = _.mapValues(
            ...
            (currPathAndReferencedBy, currInterfaceName) => {
                ...
                return getInterfaceWithDefault(
                    currInterfaceMeta,
                    fullInterfacePath
                )
            }
